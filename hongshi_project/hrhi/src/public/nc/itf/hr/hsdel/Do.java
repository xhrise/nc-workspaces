 ...
 *         &lt;element name="persons" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfstring" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Do {
    ...
    @XmlElementRef(name = "persons", namespace = "http://www.UFIDA.org", type = JAXBElement.class)
    protected JAXBElement<ArrayOfstring> persons;
     ...
     *     
     */
    public JAXBElement<ArrayOfstring> getPersons() {
        return persons;
    }
     ...
     *     
     */
    public void setPersons(JAXBElement<ArrayOfstring> value) {
        this.persons = ((JAXBElement<ArrayOfstring> ) value);
    }
