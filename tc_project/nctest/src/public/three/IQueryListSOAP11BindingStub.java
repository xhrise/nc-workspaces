  ...
  implements IQueryListPortType
{
  ...
  public String importXMLRep(String string, String string1, String string2, String string3, String string4) throws RemoteException {
    if (this.cachedEndpoint == null) {
    ...
    _call.setSOAPActionURI("urn:importXMLRep");
    _call.setEncodingStyle(null);
    _call.setProperty("sendXsiTypes", Boolean.FALSE);
    _call.setProperty("sendMultiRefs", Boolean.FALSE);
    _call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
    _call.setOperationName(new QName("http://imp.tc.itf.nc/IQueryList", "importXMLRep"));
