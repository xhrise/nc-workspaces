...
/**
 * 公式插件,同时会向工具栏添加ToolBarFormulaComp()插件
 * @author wupeng
 * 2004-8-27
 */
...
//			FormulaModel.class, "FormulaModel");
    ...
    // @edit by wangyga at 2009-3-3,上午09:43:14
	static{
...
//				new FormulaDefEditor(this, new JTextField()));
		...
		//公式初始化
		//liuyy+
//		AppWorker aw = new AppWorker("公式链初始化"){
...
//			break;
	...
	/**
	 * userActionPerformed中处理UserUIEvent.DELETECELL事件的实际处理方法
	 * 处理删除单元格时对单元格上公式的删除
	 * @param e
	 */
...
//	}
	...
	private void processClearEvent(UserUIEvent e) {
		...
		//得到当前选中的单元。modify by 2008-4-23王宇光 作剪切操作，在粘贴时清楚剪切时选中区域内容，而不是从selectModel中获得
	 ...
	 * 
	 * @param AreaFormulaModel oldFormulaModel:粘贴之前的公式模型
	 * @param IArea areaSrc：原区域
	 * @param int iPasteType：粘贴的操作类型
	 * @param boolean b_isTransfer：是否转置
	 * @param Cell[][] cells：原复制的单元数组
	 * @param boolean isInstantFml：true:单元公式;false:汇总公式
	 * @return
	 */
	...
	/** add by 王宇光 2008-4-21
	 * 实现单元的转置
	 * @param Cell[][] cell 原单元二维数组
