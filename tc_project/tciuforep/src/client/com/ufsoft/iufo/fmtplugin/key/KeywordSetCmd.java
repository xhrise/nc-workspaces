        ...
        public void execute(Object[] params) {
            ...
            for(Iterator iter = newKeyVOPos.keySet().iterator();iter.hasNext();){
                ...
                if(keyVO.getTimeKeyIndex() != -1 && oldTimeKeyVOIndex != -1 &&
                    ...
                    int j = JOptionPane.showConfirmDialog(new UIPanel(), sHint, StringResource.getStringResource("miufo1000718"), JOptionPane.YES_NO_OPTION,  //"用友集团"
