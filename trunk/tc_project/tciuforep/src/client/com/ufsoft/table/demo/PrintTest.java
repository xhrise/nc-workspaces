...
class PrintTestFrame extends JFrame
{
   ...
   {  
      ...
      canvas = new PrintPanel("Hello","World");
      add((JPanel)canvas, BorderLayout.CENTER);
         ...
         ActionListener()
         {
            public void actionPerformed(ActionEvent event)
            {
               try
               {
                  ...
                  System.out.println("system printjob name:"+nm);
...
{ 
   ...
   public PrintPanel(String word1,String word2){
	   this.word1=word1;
	   this.word2=word2;
   }
   ...
   */
   ...
   {  
      ...
      TextLayout layout = new TextLayout(word1, f, context);
      AffineTransform transform = AffineTransform.getTranslateInstance(0, 72);
      Shape outline = layout.getOutline(transform);
      clipShape.append(outline, false);

      layout = new TextLayout(word2, f, context);
