...
public class FormulaTraceBizHelper implements IUfoContextKey{	
	...
	public static IFormulaTraceBiz getFormulaTraceBiz(){
		...
		return FormulaTraceBiz.getInstance();
	}
...
//	}
	...
	public static String getFormatValueStr(Object objValValue){
		...
		if(objValValue instanceof Double || objValValue instanceof Integer){
			double value = 0;
			value = (objValValue instanceof Double)?((Double)objValValue).doubleValue():((Integer)objValValue).doubleValue();
			return IufoFormat.doGetString(value);
		}  
		return objValValue.toString();
	}
}
