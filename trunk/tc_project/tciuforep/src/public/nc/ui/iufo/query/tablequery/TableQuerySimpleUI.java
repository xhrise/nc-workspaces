...
import nc.ui.iufo.dataexchange.MultiSheetExcelNewAction;
...
public class TableQuerySimpleUI extends com.ufsoft.iufo.querycond.ui.AbsQuerySimpleUI implements IFuncOrderFlag {
	...
	//增加集团上报确认，add by yh 2011年3月10日13:55:35
	...
	private WebMenuItem menuItem_tableGroupReportCommit=null;
	private WebMenuItem menuItem_tableGroupCancel=null;
	...
	protected void setData(){
		...
		WebMenuItem[] webMenuItems = new WebMenuItem[]{menuItemWebInput,menuItemRepToolInput,menuItem_tableSwBal,
				menuItem_tableRemove,menuItem_tableRepCheck,menuItem_tableTaskCheck,menuItem_QueryCheck,
				menuItem_totalSub,menuItem_tableReportCommit,menuItem_tableAskCancel,menuItem_tableGroupReportCommit,menuItem_tableGroupCancel,menuItem_tableQueryRelease,
				...
				menuItem_multiSheetPrint,menuItem_xbrlInstanceGen};
                                            //为了控制web录入子菜单yp
		String[] strFuncOrders=new String[]{MYREP_REPDATA_INPUTWEB_VIEW,MYREP_REPDATA_INPUTREPTOOL,MYREP_REPDATA_BALANCE,
				MYREP_REPDATA_REMOVE,MYREP_REPDATA_CHECK,MYREP_REPDATA_CHECK,MYREP_REPDATA_CHECKRESULTQUERY,
				MYREP_REPDATA_TOTALSUBMNGUI,MYREP_REPDATA_RETRUNQUERY_COMMIT,MYREP_REPDATA_RETRUNQUERY_CANCEL,MYREP_REPDATA_RELEASE_RELEASE,
	...
	protected WebMenu getMenuReportCommit(){
		if (menuReportCommit==null){
			...
			menuItem_tableGroupReportCommit = new WebMenuItem();
		    fwd = new ActionForward(MultiSheetExcelNewAction.class.getName(), "execute");
		    menuItem_tableGroupReportCommit.setActionForward(fwd);
		    menuItem_tableGroupReportCommit.setSubmitType(WebMenuItem.TABLE_SUBMIT);
		    menuItem_tableGroupReportCommit.setID("A10A20A30A30");
		    menuItem_tableGroupReportCommit.setMenuLabel("上报集团");
		    menuReportCommit.add(menuItem_tableGroupReportCommit);
		    
		    menuItem_tableGroupCancel = new WebMenuItem();
		    fwd = new ActionForward(ReportCommitAction.class.getName(), "doCommitCancel");
		    menuItem_tableGroupCancel.setActionForward(fwd);
		    menuItem_tableGroupCancel.setSubmitType(WebMenuItem.TABLE_SUBMIT);
		    menuItem_tableGroupCancel.setID("A10A20A30A30");
		    menuItem_tableGroupCancel.setMenuLabel("请求集团取消上报");
		    menuReportCommit.add(menuItem_tableGroupCancel);
		}
	...
	protected WebMenu getMenuInput(){
		if (menuInput==null){
			...
			fwd=new ActionForward(TableZiorInputAction.class.getName(),"");
