...
public abstract class AbstractMyDelegator extends
	...
	public Hashtable loadChildDataAry(String[] tableCodes, String key)
		...
		nc.vo.yto.blacklist.HiPsndocBadAppBVO[] bodyVOs1 = (nc.vo.yto.blacklist.HiPsndocBadAppBVO[]) queryByCondition(
				nc.vo.yto.blacklist.HiPsndocBadAppBVO.class, getBodyCondition(
						nc.vo.yto.blacklist.HiPsndocBadAppBVO.class, key));
