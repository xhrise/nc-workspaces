...
public class PsnInfCollectUI extends nc.ui.hr.base.HRToftPanel implements
	...
	public SortConfigDialog getConfigDialog() {
		...
		if (configDialog.getSortingFields() == null
			...
			defaultSortingFields.add(new Attribute(new nc.ui.hr.comp.sort.Pair(
					"bd_corp.showorder", nc.ui.ml.NCLangRes.getInstance()
							.getStrByID("6007", "UPT6007-000229")/* "公司顺序号" */),
					true));
			defaultSortingFields.add(new Attribute(new nc.ui.hr.comp.sort.Pair(
					"bd_deptdoc.showorder", nc.ui.ml.NCLangRes.getInstance()
							.getStrByID("6007", "UPT6007-000230")/* "部门顺序号" */),
					true));
			defaultSortingFields.add(new Attribute(
					new nc.ui.hr.comp.sort.Pair("bd_psndoc.showorder",
							nc.ui.ml.NCLangRes.getInstance().getStrByID(
									"600704", "UPT600704-000325")/* "人员顺序号" */),
					true));
	...
	public HrQueryDialog getQueryDialog() {
		...
		if (queryDialog == null) {
			...
			// 合同类型
			queryDialog
					.setFieldValueElementEnum(
							"hi_psndoc_ctrt.iconttype",
	...
	protected void onDel() throws java.lang.Exception {
		...
		try {
			...
			int useroperate = MessageDialog
					.showYesNoDlg(
							this,
							nc.ui.ml.NCLangRes.getInstance().getStrByID(
									"600704", "UPP600704-000020")/* @res "提示" */,
							nc.ui.ml.NCLangRes.getInstance().getStrByID(
									"600704", "UPP600704-000074")/*
																	 * @res
																	 * "是否删除"
																	 */
...
//									break;
			...
			HIDelegator.getPsnInf().intoDoc(intoDocData, pk_psndocs2,
					Global.getUserID());
			// 效率优化end
