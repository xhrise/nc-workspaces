 ...
 */
     public class CalcStorfeeHVO extends SuperVO {
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_storfee == null) {
			errFields.add(new String("pk_storfee"));
			  }	
	 ...
	 *
	 * 创建日期:2012-9-17
	 * @param newPk_storfee 主键值
	 */
	 public CalcStorfeeHVO(String newPk_storfee) {
	  ...
	  * @param newPk_storfee  String    
	  */
	 public void setPrimaryKey(String newPk_storfee) {
