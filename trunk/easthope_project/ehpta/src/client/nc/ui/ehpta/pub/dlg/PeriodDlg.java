 ...
 */
public class PeriodDlg extends UIDialog implements ActionListener {
	...
	public PeriodDlg() throws Exception {
		
		init();
	}
	
	public PeriodDlg(Container parent ) throws Exception {
		super(parent);
