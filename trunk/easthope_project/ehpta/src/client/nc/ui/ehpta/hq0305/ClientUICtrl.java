...
public class ClientUICtrl extends AbstractManageController {
	...
	public int[] getCardButtonAry() {
		...
		return new int[] { IBillButton.Query, IBillButton.Add,
				DefaultBillButton.Statistics , IBillButton.Edit, 
				IBillButton.Refresh, IBillButton.Save,
				IBillButton.Cancel, IBillButton.Delete,
				IBillButton.Commit, IBillButton.Audit, 
				IBillButton.CancelAudit, IBillButton.ApproveInfo,
	...
	public String[] getBillVoName() {
		return new String[] { HYBillVO.class.getName(),
				SaleBalanceHVO.class.getName(), SaleBalanceBVO.class.getName() };
	}
