 ...
 * @author：平台脚本生成
 */
public class CHG30TO4C extends nc.bs.pf.change.VOConversion {
	/**
	 * CHG30TO4C 构造子注解。
	 */
	public CHG30TO4C() {
	...
	public String[] getField() {
		return new String[] {
				...
				"H_ts->H_ts", "H_cdilivertypeid->H_ctransmodeid",
				"H_vnote->H_vnote", "H_cwhsmanagerid->B_cstoreadmin",
				"H_freplenishflag->H_bretinvflag",

				"B_vfree2->B_vfree2", "B_vfree1->B_vfree1",
				"B_cinventoryid->B_cinventoryid",
				"B_cprojectphaseid->B_cprojectphaseid",
				"B_cprojectid->B_cprojectid", "B_vuserdef6->B_vdef6",
				"B_vuserdef5->B_vdef5", "B_vuserdef4->B_vdef4",
				"B_vuserdef3->B_vdef3", "B_vuserdef2->B_vdef2",
				"B_vuserdef1->B_vdef1", "B_vuserdef7->B_vdef7",
				"B_vuserdef8->B_vdef8", "B_vuserdef9->B_vdef9",
				...
				"B_vuserdef20->B_vdef20", "B_csourcebillhid->B_csaleid",
				"B_vfree5->B_vfree5", "B_vfree4->B_vfree4",
				"B_vfree3->B_vfree3", "B_csourcebillbid->B_corder_bid",
				"B_vbatchcode->B_cbatchid",
				"B_vsourcebillcode->H_vreceiptcode",
				"B_cfreezeid->B_cfreezeid", "B_cfirstbillbid->B_corder_bid",
				"B_cfirstbillhid->B_csaleid", "B_cfirsttype->H_creceipttype",
				"B_castunitid->B_cpackunitid", "B_flargess->B_blargessflag",
				"B_csourceheadts->H_ts", "B_csourcebodyts->B_ts",
				"B_vnotebody->B_frownote", "B_creceieveid->B_creceiptcorpid",
				"B_breturnprofit->B_breturnprofit",
				"B_bsafeprice->B_bsafeprice", "B_vsourcerowno->B_crowno",
				"B_nsaleprice->B_nnetprice", "B_ntaxprice->B_ntaxnetprice",
				"B_cinvbasid->B_cinvbasdocid", "B_cinvmanid->B_cinvbasdocid",
