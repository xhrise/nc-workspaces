...
insert into pub_votable (APPROVEID, BILLID, BILLNO, BILLVO, BUSITYPE, DEF1, DEF2, DEF3, DR, HEADBODYFLAG, HEADITEMVO, ITEMCODE, OPERATOR, PK_BILLTYPE, PK_CORP, PK_VOTABLE, PKFIELD, TS, VOTABLE)
values ('vapproveid', 'pk_transport', 'vbillno', 'nc.vo.ehpta.hq010101.MyBillVO', 'pk_busitype', null, null, null, null, 'Y', 'nc.vo.ehpta.hq010101.TransportContractVO', null, 'voperatorid', 'HQ02', null, '0001AA1000000020KEFP', 'pk_transport', '2012-07-23 22:25:09', 'ehpta_transport_contract');

insert into pub_votable (APPROVEID, BILLID, BILLNO, BILLVO, BUSITYPE, DEF1, DEF2, DEF3, DR, HEADBODYFLAG, HEADITEMVO, ITEMCODE, OPERATOR, PK_BILLTYPE, PK_CORP, PK_VOTABLE, PKFIELD, TS, VOTABLE)
values (null, null, null, 'nc.vo.ehpta.hq010101.MyBillVO', null, null, null, null, null, 'N', 'nc.vo.ehpta.hq010101.EhptaTransportContractBVO', null, null, 'HQ02', null, '0001AA1000000020KEFQ', 'pk_transport', '2012-07-23 22:25:09', 'ehpta_transport_contract_b');

insert into pub_votable (APPROVEID, BILLID, BILLNO, BILLVO, BUSITYPE, DEF1, DEF2, DEF3, DR, HEADBODYFLAG, HEADITEMVO, ITEMCODE, OPERATOR, PK_BILLTYPE, PK_CORP, PK_VOTABLE, PKFIELD, TS, VOTABLE)
values ('vapproveid', 'pk_hangingprice', 'vbillno', 'nc.vo.ehpta.hq010301.MyBillVO', 'pk_busitype', null, null, null, null, 'Y', 'nc.vo.ehpta.hq010301.EhptaHangingpriceVO', null, 'voperatorid', 'HQ03', null, '1120A11000000011CTME', 'pk_hangingprice', '2012-07-04 14:55:41', 'ehpta_hangingprice');
...
insert into pub_votable (APPROVEID, BILLID, BILLNO, BILLVO, BUSITYPE, DEF1, DEF2, DEF3, DR, HEADBODYFLAG, HEADITEMVO, ITEMCODE, OPERATOR, PK_BILLTYPE, PK_CORP, PK_VOTABLE, PKFIELD, TS, VOTABLE)
values ('vapproveid', 'pk_storfare', 'vbillno', 'nc.vo.ehpta.hq010202.MyBillVO', 'pk_busitype', null, null, null, null, 'Y', 'nc.vo.ehpta.hq010501.StorfareVO', null, 'voperatorid', 'HQ05', null, '1120A11000000011EEPO', 'pk_storfare', '2012-07-09 14:53:08', 'ehpta_storfare');

insert into pub_votable (APPROVEID, BILLID, BILLNO, BILLVO, BUSITYPE, DEF1, DEF2, DEF3, DR, HEADBODYFLAG, HEADITEMVO, ITEMCODE, OPERATOR, PK_BILLTYPE, PK_CORP, PK_VOTABLE, PKFIELD, TS, VOTABLE)
values (null, null, null, 'nc.vo.ehpta.hq010202.MyBillVO', null, null, null, null, null, 'N', 'nc.vo.ehpta.hq010501.EhptaStorfareBVO', null, null, 'HQ05', null, '1120A11000000011EEPP', 'pk_storfare', '2012-07-09 14:53:08', 'ehpta_storfare_b');
...
insert into pub_votable (APPROVEID, BILLID, BILLNO, BILLVO, BUSITYPE, DEF1, DEF2, DEF3, DR, HEADBODYFLAG, HEADITEMVO, ITEMCODE, OPERATOR, PK_BILLTYPE, PK_CORP, PK_VOTABLE, PKFIELD, TS, VOTABLE)
values ('vapproveid', 'pk_adjust', 'vbillno', 'nc.vo.ehpta.hq010403.MyBillVO', 'pk_busitype', null, null, null, null, 'Y', 'nc.vo.ehpta.hq010403.AdjustVO', null, 'voperatorid', 'HQ07', null, '0001AA1000000020K4D6', 'pk_adjust', '2012-07-22 20:47:57', 'ehpta_adjust');
