...
to_date(genh.dbilldate , 'yyyy-MM-dd') - to_date((select max(dbizdate) from ic_general_b where cbodywarehouseid = genh.cwarehouseid and vbatchcode =  genb.vbatchcode and nvl(dr,0) = 0 and csourcetype = '4K' and cbodybilltypecode = '4A' and cinventoryid = genb.cinventoryid) , 'yyyy-MM-dd') + 1 def1 , 
...
genh.transprice storprice ,
(case when ((case when to_date(saleb.deliverydate , 'yyyy-MM-dd') - to_date(genh.dbilldate , 'yyyy-MM-dd') > 0 then to_date(genh.dbilldate , 'yyyy-MM-dd') - to_date((select max(dbizdate) from ic_general_b where cbodywarehouseid = genh.cwarehouseid and vbatchcode =  genb.vbatchcode and nvl(dr,0) = 0 and csourcetype = '4K' and cbodybilltypecode = '4A' and cinventoryid = genb.cinventoryid)  , 'yyyy-MM-dd') else to_date(saleb.deliverydate , 'yyyy-MM-dd') - to_date((select max(dbizdate) from ic_general_b where cbodywarehouseid = genh.cwarehouseid and vbatchcode =  genb.vbatchcode and nvl(dr,0) = 0 and csourcetype = '4K' and cbodybilltypecode = '4A' and cinventoryid = genb.cinventoryid)  , 'yyyy-MM-dd') end ) + 1) - nvl(storcontb1.concesessionsday,0) < 0 then 0 else ((case when to_date(saleb.deliverydate , 'yyyy-MM-dd') - to_date(genh.dbilldate , 'yyyy-MM-dd') > 0 then to_date(genh.dbilldate , 'yyyy-MM-dd') - to_date((select max(dbizdate) from ic_general_b where cbodywarehouseid = genh.cwarehouseid and vbatchcode =  genb.vbatchcode and nvl(dr,0) = 0 and csourcetype = '4K' and cbodybilltypecode = '4A' and cinventoryid = genb.cinventoryid)  , 'yyyy-MM-dd') else to_date(saleb.deliverydate , 'yyyy-MM-dd') - to_date((select max(dbizdate) from ic_general_b where cbodywarehouseid = genh.cwarehouseid and vbatchcode =  genb.vbatchcode and nvl(dr,0) = 0 and csourcetype = '4K' and cbodybilltypecode = '4A' and cinventoryid = genb.cinventoryid)  , 'yyyy-MM-dd') end ) + 1) - nvl(storcontb1.concesessionsday,0) end) * genh.transprice * genb.noutnum stormny
