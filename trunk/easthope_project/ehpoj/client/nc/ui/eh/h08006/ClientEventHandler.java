...
import nc.vo.eh.h08006.CubasdocVO;
import nc.vo.pub.BusinessException;

/**
 * 
功能：从NC中把客商数据导入到U8客商表中
作者：zqy
...
public class ClientEventHandler  extends CardEventHandler {
    ...
    private void onBoStockCope() throws Exception {  //读取NC客商的数据,并在界面上显示出来
        ...
        .append(" where isnull(lock_flag,'N')='N' and custprop in (0,2) and pk_corp='"+pk_corp+"' and isnull(dr,0)=0 ");
    ...
    private void onBoStockChange() throws BusinessException {  //把显示在界面上的数据给塞到U8客商表中,如果有重复的则UPDATE
        ...
        StringBuffer SQL = pubItf.Datepass(vo);
