 ...
 */
package nc.ui.eh.report.h010003;
...
import nc.vo.eh.report.h010003.JtcpqjmxVO;
 ...
 */
public class JtcpjgqjmxReportUI extends ToftPanel {
	...
	public ReportBaseClass getReportBase()
	{
	    if(m_report == null)
	        try
	        {
	            ...
	            m_report.setTempletID(getCorpPrimaryKey(), "H0906006", null, null);
	      }
	        catch(Exception ex)
	        {
	...
	protected QueryConditionClient createQueryDLG()
	{
	    ...
	    dlg.setTempletID(getCorpPrimaryKey(), "H0906006", null, null);
	...
	public void onQuery() throws Exception{
		   ...
		   if(getQryDlg().getResult() == 1)
		   {
		   	  ...
		   	  JtcpqjmxVO[] vos= pubitf.jtcpqjmx(begindate,enddate);
		   	 ...
		   	 if (vos!=null&&vos.length>0){
		   		getReportBase().getHeadItem("begindate").setValue(begindate);
	   	  		...
	   	  		for(int i=0;i<fileds.length;i++){
	   	  			...
	   	  			if(filed.endsWith("l")||filed.endsWith("zb")){
	   	  			   arrFileds.add(filed);
	   	  			}
	   	  		}
	   	  		//显示合计项
	   	  		String[] strsubValKeys = (String[])arrFileds.toArray(new String[arrFileds.size()]);
		        String[] strgrpValKeys = {"productclass1,productclass2"};
		        ...
		        stctx.setTotalNameColKeys("productclass1");	//设置合计项显示列位置
