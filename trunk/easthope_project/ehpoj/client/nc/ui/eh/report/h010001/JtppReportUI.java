 ...
 */
package nc.ui.eh.report.h010001;
...
import nc.vo.eh.report.h010001.JtppVO;
 ...
 */
public class JtppReportUI extends ToftPanel {
	...
	public ReportBaseClass getReportBase()
	{
	    if(m_report == null)
	        try
	        {
	            ...
	            m_report.setTempletID(getCorpPrimaryKey(), "H0906004", null, null);
	      }
	        catch(Exception ex)
	        {
	...
	protected QueryConditionClient createQueryDLG()
	{
	    ...
	    dlg.setTempletID(getCorpPrimaryKey(), "H0906004", null, null);
	...
	public void onQuery() throws Exception{
		   ...
		   if(getQryDlg().getResult() == 1)
		   {
			  ...
			  JtppVO[] vos= pubitf.calcJtppxl(begindate,enddate);
		   	 ...
		   	 if (vos!=null&&vos.length>0){
	   	  		...
	   	  		for(int i=0;i<fileds.length;i++){
	   	  			...
	   	  			if(filed.endsWith("xl")||filed.endsWith("ze")){
	   	  			   arrFileds.add(filed);
	   	  			}
	   	  		}
	   	  		//显示合计项
	   	  		String[] strsubValKeys = (String[])arrFileds.toArray(new String[arrFileds.size()]);
		        String[] strgrpValKeys = {"productclass1"};
