 ...
 * @date  2008-4-12
 */
public class InvBOMRefModel extends AbstractRefGridTreeModel {
 ...
 */
public InvBOMRefModel(String sGroupID,String corpID,String codeRule) {
	super();
...
public java.lang.String[] getFieldCode() {
	return new String[]{"invname","invcode","invmnecode","invspec","invtype","colour","def_2","pk_invcl","pk_invbasdoc"};
}
/**
 * 显示字段中文名
 * 创建日期：(01-4-4 0:57:23)
...
public java.lang.String[] getFieldName() {
	return new String[]{"产品名称","产品编码","助记码","规格","型号","颜色","品牌","树主键","主键"};
}
/**
 * 主键字段名
 * @return java.lang.String
