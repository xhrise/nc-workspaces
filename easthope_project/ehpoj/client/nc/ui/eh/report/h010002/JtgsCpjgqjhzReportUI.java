 ...
 */
package nc.ui.eh.report.h010002;
...
import nc.vo.eh.report.h010002.CorpcpjgqjVO;
 ...
 */
public class JtgsCpjgqjhzReportUI extends ToftPanel {
	...
	public ReportBaseClass getReportBase()
	{
	    if(m_report == null)
	        try
	        {
	            ...
	            m_report.setTempletID(getCorpPrimaryKey(), "H0906005", null, null);
	      }
	        catch(Exception ex)
	        {
	...
	protected QueryConditionClient createQueryDLG()
	{
	    ...
	    dlg.setTempletID(getCorpPrimaryKey(), "H0906005", null, null);
	...
	public void onQuery() throws Exception{
		   ...
		   if(getQryDlg().getResult() == 1)
		   {
		   	  ...
		   	  CorpcpjgqjVO[]  vos= pubitf.corpcpjgqjhz(begindate,enddate);
