 ...
 */
package nc.ui.eh.report.h010004;
...
import nc.vo.eh.report.h010004.JtgscpzlqjVO;
 ...
 */
public class JtgscpzlqjReportUI extends ToftPanel {
	...
	public ReportBaseClass getReportBase()
	{
	    if(m_report == null)
	        try
	        {
	            ...
	            m_report.setTempletID(getCorpPrimaryKey(), "H0906007", null, null);
	      }
	        catch(Exception ex)
	        {
	...
	{
		FuncRegisterVO 	vo = getFrame().getFuncRegisterVO();
		System.out.println(vo.getFunCode());
		QueryConditionClient dlg = new QueryConditionClient();
	    dlg.setTempletID(getCorpPrimaryKey(), "H0906007", null, null);
	...
	public void onQuery() throws Exception{
		   ...
		   if(getQryDlg().getResult() == 1)
		   {
		   	  ...
		   	  JtgscpzlqjVO[] vos= pubitf.jtgscpzlqj(begindate,enddate);
