...
public class ClientCtrl extends AbstractCtrl {
	...
	public int[] getCardButtonAry() {
	      ...
	      int[] btns1 = nc.ui.eh.button.ButtonTool.insertButtons(new int[] { IEHButton.EditionChange,IBillButton.Copy},btns, 15);//modify by houcq 2010-11-30取消成品标准单的关闭按钮
	      return btns1;
	}
