 ...
 */
public abstract class VoucherBaseDLG extends SystemBaseDLG {
    ...
    /**查询框*/
    protected VoucherBaseBillQueryDLG     queryCondition     = null;
    /**缓存VO[]*/
    protected AggregatedValueObject[]      m_Vos              = null;
    
   
    public VoucherBaseDLG(String pkField, String pkCorp, String operator, String funNode,
     ...
     */
    protected abstract VoucherBaseBillQueryDLG getQueryDlg();
    /**
     * 功能: 查询条件
     * @author 王建超
	...
	public void loadHeadData() {
        try {
            ...
            SuperVO[] parentvo = HYPubBO_Client.queryByCondition(Class.forName(BillVos), tmpWhere);
