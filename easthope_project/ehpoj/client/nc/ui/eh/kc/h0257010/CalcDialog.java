...
//		    Collection co = iUAPQueryBS.retrieveByClause(ArapCosthsVO.class, " nyear = "+perVO.getNyear()+" and nmonth = "+perVO.getNmonth()+" and pk_corp = '"+ce.getCorporation().getPk_corp()+"'and isnull(dr,0)=0");
//		    if(co==null||co.size()==0){
//		    	JOptionPane.showMessageDialog(this,   perVO.getNyear()+"年"+perVO.getNmonth()+"月的成本还未核算,不能计算成品月报表!", "警告",0);
//		        return;
//		    }
