 ...
 */
     public class CalcRebatesHVO extends SuperVO {
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_rebates == null) {
			errFields.add(new String("pk_rebates"));
			  }	
	 ...
	 *
	 * 创建日期:2012-9-26
	 * @param newPk_rebates 主键值
	 */
	 public CalcRebatesHVO(String newPk_rebates) {
	  ...
	  * @param newPk_rebates  String    
	  */
	 public void setPrimaryKey(String newPk_rebates) {
