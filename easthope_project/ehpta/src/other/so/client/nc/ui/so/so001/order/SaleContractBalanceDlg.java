...
//				);
				...
				Vector retVector = (Vector) UAPQueryBS.iUAPQueryBS.executeQuery("select typename , mny from vw_pta_sale_contract_balance where pk_contract = '"+pk_contract+"'", new VectorProcessor());
